  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Master your financial knowledge</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow mb-8">
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <h3 className="text-lg font-medium text-gray-600">Completed Modules</h3>
              <p className="text-3xl font-bold mt-2">2/6</p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-600">Total Time Spent</h3>
              <p className="text-3xl font-bold mt-2">45 mins</p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-600">Knowledge Score</h3>
